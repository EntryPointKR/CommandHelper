...
/**
 * A capability list is a list of known supported
...
public class CapabilityList {
     ...
     *                   to automatically determine server capabilites when required.
     */
    ...
    public static enum CapabilityValue {
         ...
         * the client should never request if this is
         * supported or not. (It still may fail, but that is unexpected).
         * This is generally reserved for core operations, but
         * may be also used for other requests. If the request fails, it
         * will not automatically switch the value of this capability, however,
         * the server may still actively change the capability value.
         */
        ...
        UNSUPPORTED(true),
        /**
         * This capability is requested from the server each time it is used, and
         * that new value is temporarily used to determine support or not.
         */
        DYNAMIC(true),
        /**
