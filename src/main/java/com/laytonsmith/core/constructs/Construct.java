...
public abstract class Construct implements Cloneable, Comparable<Construct>, Mixed {
    ...
    /**
     * This function takes a Construct, and turns it into a JSON value. If the
     * construct is not one of the following, a MarshalException is thrown:
     * CArray, CBoolean, CDouble, CInt, CNull, CString, CVoid, Command.
     * Currently unsupported, but will be in the future are: CClosure/CFunction
     * The following map is applied when encoding and decoding:
     * <table border='1'>
     * <tr><th>JSON</th><th>MethodScript</th></tr>
     * <tr><td>string</td><td>CString, CVoid, Command, but all are decoded into
     * CString</td></tr>
     * <tr><td>number</td><td>CInt, CDouble, and it is decoded
     * intelligently</td></tr>
    ...
    /**
     * This method should only be used by Script when setting the children's
     * target, if it's an ivariable.
     *
     * @param target
     */
    ...
    /**
     * Returns the standard string representation of this Construct. This will
     * never return null.
     *
     * @return
     */
    ...
    /**
     * Returns the standard string representation of this Construct, except in
     * the case that the construct is a CNull, in which case it returns java
     * null.
     *
     * @return
     */
