...
public class Scoreboards {
    ...
    public static class remove_scoreboard extends SBFunction {
        ...
        public Construct exec(Target t, Environment environment,
            ...
            if (nullify) {
                ...
                for (MCOfflinePlayer player : s.getPlayers()) {
                    s.resetScores(player);
                }
    ...
    public static class get_pscore extends SBFunction {
        ...
        public Construct exec(Target t, Environment environment,
            ...
            return new CInt(o.getScore(Static.getServer().getOfflinePlayer(args[1].val())).getScore(), t);
        }
    ...
    public static class set_pscore extends SBFunction {
        ...
        public Construct exec(Target t, Environment environment,
            ...
            o.getScore(Static.getServer().getOfflinePlayer(args[1].val())).setScore(Static.getInt32(args[2], t));
            return CVoid.VOID;
        }
    ...
    public static class reset_all_pscores extends SBFunction {
        ...
        @Override
        public Construct exec(Target t, Environment environment, Construct... args) throws ConfigRuntimeException {
            assignBoard(2, 1, t, args)
                    .resetScores(Static.getServer().getOfflinePlayer(args[0].val()));
            return CVoid.VOID;
        }
