...
public class BukkitMCPlayer extends BukkitMCHumanEntity implements MCPlayer, MCCommandSender, MCOfflinePlayer {
    ...
    public void setTempOp(Boolean value) throws ClassNotFoundException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        try {
            ...
            Object nmsPlayerList = ReflectionUtils.invokeMethod(nmsServer, "getPlayerList");
			/*n.m.s.OpList*/
            Object opSet = ReflectionUtils.get(ClassDiscovery.getDefaultInstance().forFuzzyName("net.minecraft.server.*", "PlayerList").loadClass(), nmsPlayerList, "operators");
            ...
            if (value) {
				/*n.m.s.OpListEntry*/
                Class nmsOpListEntry = ClassDiscovery.getDefaultInstance().forFuzzyName("net.minecraft.server.*", "OpListEntry").loadClass();
                Class nmsGameProfile;
                try {
					/*net.minecraft.util.com.mojang.authlib.GameProfile*/
                    nmsGameProfile = Class.forName("net.minecraft.util.com.mojang.authlib.GameProfile");
                } catch (ClassNotFoundException eee) {
                    // Probably 1.8
					/*com.mojang.authlib.GameProfile*/
                    nmsGameProfile = Class.forName("com.mojang.authlib.GameProfile");
                }
    ...
    public void playSound(MCLocation l, String sound, float volume, float pitch) {
        p.playSound(((BukkitMCLocation) l).asLocation(), Sound.valueOf(sound.toUpperCase()), volume, pitch);
    }
